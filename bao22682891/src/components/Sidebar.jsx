    ...
    <div className='sidebar'>
            ...
            <ul className='head_sidebar'>
              <NavLink to={'/'} style={({ isActive }) => ({
                  ...
                  backgroundColor: isActive ? '#F44B87' : 'transparent'
                })}> <li>
                ...
                Teams</li> </NavLink>
                <NavLink to={'/analytic'} style={({ isActive }) => ({
                  textDecoration: 'none',
                  color: isActive ? 'white' : 'black',
                  backgroundColor: isActive ? '#F44B87' : 'transparent'
                ...
                Messages</li> </NavLink>
                <NavLink to={'/integration'} style={({ isActive }) => ({
                  textDecoration: 'none',
                  color: isActive ? 'white' : 'black',
                  backgroundColor: isActive ? '#F44B87' : 'transparent'
                })}> <li>                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
